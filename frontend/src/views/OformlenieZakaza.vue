<template>
	<main>
	<div class="center">
		<input type="text"  class="ol fam" v-model="fam" textarea placeholder="Фамилия" onfocus="placeholder='';" onblur="placeholder='Фамилия';">
		<input type="text" class="ol name " v-model="name" textarea placeholder="Имя" onfocus="placeholder='';" onblur="placeholder='Имя';">
		<input type="text" class="ol sername" v-model="sername" textarea placeholder="Отчество" onfocus="placeholder='';" onblur="placeholder='Отчество';">
		<input type="number" class="ol phone" v-model="phone" textarea placeholder="Номер телефона" onfocus="placeholder='';" onblur="placeholder='Номер телефона';">
		<input type="text" class="ol mail" v-model="email" textarea placeholder="e-mail" onfocus="placeholder='';" onblur="placeholder='e-mail';">
		<input type="text" class="ol login" id="1" v-model="PriceAll" textarea placeholder="Цена" onfocus="placeholder='';" onblur="placeholder='Цена';">
		<div>

		<select v-model="selectedProv" class="oli v">
			<option v-for="item in listProv" v-bind:value="item.id" :key="item.id">{{item.name}}</option>
		</select>
		</div>
		<a href="#"><button class="ol re" type="button" @click="addinfo()">Продолжить</button></a>
	</div>
	</main>
</template>
<style lang="scss">
    ...
    async addinfo() {
        try {
          await axios.post("http://localhost:5000/", {
            ...
            CityOfDostavka:this.key,
            },
          });
			this.$router.push("/TypTransportiration");
        } catch (err) {
